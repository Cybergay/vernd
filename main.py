...
Король кринжа(Шомка): 1 косяк,500 руб отдал
Тимур Гиндулла: 2 косяка
Тимур Шамс: 6 косяков, 1000руб не отдал
Тимур абс: 1 косяк
Артур: -1(минус один) косяк
Шайдуллин: 3 косяка, 500 рублей не отдал
Тагири: 0 косяков, 500 руб отдал
Булабар: 0 косяков
"""
...
kozyaki_details = {
    ...
    "Булабар": [
        {"дата": "-", "причина": "за балкон, или за чашку "},
    ],
}
...
def send_photo_of_king(message):
    try:
        with open(r'C:\Users\Артур\PycharmProjects\bot_vernadka\2 булат.jpg', 'rb') as photo:  # Убедись, что путь к фото корректный
